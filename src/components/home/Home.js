...
const Home = (props) => {
  ...
  return (
    <div className='main main-bar bar'>
      <div class="card mb-3">
        <img class="card-img-top" src="https://images.unsplash.com/photo-1520962880247-cfaf541c8724?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1489&q=80" alt="A man seeking peace" />
        <div class="card-body">
          <h5 class="card-title">Do you need <span className="peace">Peace</span> in this world of chaos?</h5>
          <p class="card-text">If your answer is YES, then we are here to do that. You can discuss the things
